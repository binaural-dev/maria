...
class InheritedResCompany(models.Model):
    ...
    economic_activity_number = fields.Char(string="Número de actividad económica")
    ...
    def fields_view_get(self, view_id=None, view_type=False, toolbar=False, submenu=False):
        ...
        if municipality_retention and view_type == "form":
            ...
            modifiers_logo = json.loads(logo_hacienda_field.get("modifiers") or '{}')
            ...
            modifiers_name_hacienda = json.loads(name_hacienda_field.get("modifiers") or '{}')
            modifiers_name_hacienda['invisible'] = False
            modifiers_name_hacienda['required'] = True
            name_hacienda_field.set('modifiers', json.dumps(modifiers_name_hacienda))
            
            # invisible numero de actividad económica
            economic_activity_number_field = doc.xpath(
                "//field[@name='economic_activity_number']")[0]
            modifiers_economic_activity_number = json.loads(economic_activity_number_field.get("modifiers") or '{}')
            modifiers_economic_activity_number['invisible'] = False
            modifiers_economic_activity_number['required'] = True
            economic_activity_number_field.set('modifiers', json.dumps(modifiers_economic_activity_number))
