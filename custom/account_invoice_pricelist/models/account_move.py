...
class AccountMoveLine(models.Model):
    ...
    def _onchange_product_id_account_invoice_pricelist(self):
        for sel in self:
            ...
            sel.with_context(check_move_validity=False)._onchange_price_subtotal()
            sel.with_context(check_move_validity=False)._amount_all_foreign()
